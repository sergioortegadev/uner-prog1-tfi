...
from models.herramientas import find_tool_by_id, update_tool, ToolType, ToolStatus
from enum import Enum

MAINTENANCE_FILE = "mantenimientos.json"
REQUIRED_MAINTENANCE_FIELDS = ["id_herramienta",
...
def create_maintenance(maintenance_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    new_record = {
        ...
        "id_herramienta": maintenance_data["id_herramienta"],
    ...
    if "costo" in maintenance_data:
        new_record["costo"] = maintenance_data["costo"]
    if "proximo_mantenimiento" in maintenance_data:
        new_record["proximo_mantenimiento"] = maintenance_data["proximo_mantenimiento"]
